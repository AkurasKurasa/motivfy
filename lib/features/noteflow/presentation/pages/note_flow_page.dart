...
import 'package:motiv_fy/features/tasks/presentation/pages/manual_task_create_page.dart';
...
class NoteFlowPage extends StatefulWidget {
  const NoteFlowPage({super.key});

  @override
  State<NoteFlowPage> createState() => _NoteFlowPageState();
}

class _NoteFlowPageState extends State<NoteFlowPage> {
              ...
              TweenAnimationBuilder<double>(
                ...
                builder: (context, value, child) {
                  ...
                  if (value < 0.12) {
                    ...
                    final RenderBox? menuIconBox =
                        _menuIconKey.currentContext?.findRenderObject()
                            as RenderBox?;
                    final menuIconPos = menuIconBox != null
                        ? menuIconBox.localToGlobal(Offset.zero)
                        : const Offset(40, 80);

                    final endPos = menuIconPos;
                      ...
                      child: TabSelector(
                        ...
                        onTabChanged: (index) {
                          if (index == 1) {
                            ...
                            print(
                              'Saving text before navigation: ${_noteFlowService.noteText}',
                            );
