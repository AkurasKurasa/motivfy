...
/// Helper class for handling emoji selection and display
class EmojiHelper {
  /// Build a choice chip for selecting emoji type
  ...
  /// Build emoji grid for standard emojis
  static Widget buildEmojiGrid(int selectedIndex, Function(int) onTap) {
  ...
  /// Build emoji grid for animated emojis
  static Widget buildAnimatedEmojiGrid(int selectedIndex, Function(int) onTap) {
    return ListView.builder(
      scrollDirection: Axis.horizontal,
  ...
  /// Build the currently selected emoji display
  static Widget buildSelectedEmojiDisplay(
    ...
    return Container(
      ...
      child: Center(
        child: showAnimated
            ? Lottie.asset(
                TaskFormUtils.animatedEmojiOptions[animatedIndex],
                repeat: true,
                animate: true,
              )
            : Text(
                TaskFormUtils.emojiOptions[standardIndex],
                style: const TextStyle(fontSize: 24),
              ),
      ),
    );
...
/// Date/time picker container widget
